...
- [x] 보너스 로또 번호는 당첨 로또 번호와 겹치면 안된다.
  - 당첨 로또 번호가 [1, 2, 3, 4, 5, 6]일 때 보너스 로또 번호에 `6`을 넣을 경우 당첨 번호와 보너스 로또 번호가 겹치기 때문에 예외(IllegalArgumentException)를 던진다.
  - 당첨 로또 번호가 [1, 2, 3, 4, 5, 6]일 때 보너스 로또 번호에 `7`을 넣을 경우 7을 가진 보너스 로또 번호가 생성되어야 한다.
...
 수동으로 구매할 로또 수를 입력해 주세요.<br/>
 1<br/>

 수동으로 구매할 번호를 입력해 주세요.<br/>
 8, 21, 23, 41, 42, 43<br/>

 수동으로 1장, 자동으로 1개를 구매했습니다.<br/>
 [8, 21, 23, 41, 42, 43]<br/>
 [3, 5, 11, 16, 32, 38]<br/>
