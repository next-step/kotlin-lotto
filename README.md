...
- 로또 구입 금액을 입력하면 구입 금액에 해당하는 로또를 발급해야 한다.
  - 로또판매기가 있다.
    ...
    - [x] 로또판매기에 수동으로 선택한 로또숫자열과 함께 돈을 주고 로또를 살 수 있다.
...
- 수동으로 구매할 로또 개수를 입력받는다
  - [x] 로또 개수를 입력받는다
  - [x] 입력한 로또 개수가 1 이상이 아니라면 수동으로 구매할 개수는 0으로 취급한다
  - [x] 입력한 값이 숫자가 아니라면 수동으로 구매할 개수는 0으로 취급한다
- 수동으로 구매할 로또 개수만큼 로또 번호를 입력받는다
  - [x] 안내문구를 띄운다
  - [x] 수동 구매 개수가 없다면 안내문구를 띄우지 않고 다음으로 넘어간다
  - [x] 숫자 6개를 입력받는다
  - [x] 입력한 로또 수만큼 반복하여 숫자 6개를 입력받는다
  - [x] 입력한 로또 번호가 유효하지 않은 번호라면 다시 입력받는다
    - 유효함의 기준은 로또숫자열이다
- 로또구입금액에 따른 구매결과를 출력한다
  - [x] 구매결과뷰는 구매한 로또들을 받아 구매결과를 출력한다
    - 로또 개수를 출력한다
    - 각 로또의 숫자들을 출력한다
  - [x] 수동 개수와 자동 개수를 별도로 출력한다
  - [x] 구매한 로또의 번호를 나열할 때 수동 입력 순 다음 자동 순으로 나열한다
- 지난주당첨번호를 입력받는다
  - [x] 숫자 6개와 보너스 숫자 하나를 받는다
  - [x] 입력한 당첨번호가 유효하지 않은 번호라면 다시 입력받는다
    - 유효함의 기준은 로또숫자열이다
  - [x] 입력한 보너스 숫자가 유효하지 않은 번호라면 다시 입력받는다
    - 유효함의 기준은 당첨번호이다
  - [x] 당첨번호 객체로 변환한다
- 당첨통계를 출력한다
