...
- [x] 구매한 로또 목록에서 당첨 번호와 일치하는 게 3개이면 5등이다. (5000원)
- [x] 구매한 로또 목록에서 당첨 번호와 일치하는 게 4개이면 4등이다. (50000원)
- [x] 구매한 로또 목록에서 당첨 번호와 일치하는 게 5개이면 3등이다. (1500000원)
- [ ] 구매한 로또 목록에서 당첨 번호와 일치하는 게 5개이고, 남은 한 개의 번호가 보너스 번호와 일치하면 2등이다. (2000000000원)
- [x] 구매한 로또 목록에서 당첨 번호와 일치하는 게 6개이면 1등이다. (2000000000원)
- [x] 로또 번호는 6개, 1부터 45 사이의 숫자, 중복 불가여야 한다.
- [x] 수익률을 계산해야 한다. (당첨 금액 / 구매 금액 의 소수점 둘째자리까지 버림)
- [ ] 입력받은 보너스 번호가 기존 당첨 번호에 포함되지 않아야 한다.
## 힌트
