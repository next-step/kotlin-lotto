...
- [x] 사용자에게 수동으로 구매할 로또 수를 입력받는다
- [x] 사용자에게 수동으로 로또 번호를 입력받는다
- [x] 수동으로 로또를 구매할 수 있다
- [x] 수동으로 구매한 로또 외에는 자동으로 구매한다

### 기능 요구 사항

- 현재 로또 생성기는 자동 생성 기능만 제공. 사용자가 수동으로 추첨 번호를 입력할 수 있도록 해야함
- 입력한 금액, 자동 생성 숫자, 수동 생성 번호를 입력하도록 해야함
