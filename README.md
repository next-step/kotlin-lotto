...
### wallet
- [x] 수동으로 구매할 로또를 입력받아 구매한다.
- [x] 수동으로 구매할 로또가 현재 구입가능 금액을 넘어가는 경우 예외가 발생한다.
- [x] 수동으로 구매가 가능하므로 랜덤 로또를 구매할 수 없어도 0개 구매로 반환한다.
- [x] wallet 생성 시 로또 구매 가능 여부에 따라 예외가 발생한다.
