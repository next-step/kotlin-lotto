...
### 기능 목록
- [x] 1 ~ 45 까지의 로또 번호에서 랜덤한 숫자의 로또를 생성할 수 있다.
...
- [x] 당첨 개수를 전달 받아 당첨 금액을 산정할 수 있다.
- [x] 산정 된 당첨 정보를 통해 구입한 금액과의 수익률을 구할 수 있다.
- [x] 보너스볼을 입력 받아 보너스당첨이 나올 수 있다.
- [x] 구매 금액으로 자동 로또와 수동 로또도 같이 발급 받을 수 있다.
