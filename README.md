...
- 현재 로또 생성기는 자동 생성 기능만 제공한다. 사용자가 수동으로 추첨 번호를 입력할 수 있도록 해야 한다.
  - [x] 수동 로또 생성기를 가진다.
    - [x] 로또 생성기를 구현한다.
    - [x] 전달받은 번호 정보로 로또 일급 컬렉션을 만든다. 
    - [x] 전달받은 번호 정보가 없을 경우 빈 리스트를 반환한다. 
  - 자동 로또 생성기는
    - [x] 잔여 금액(구입 금액에서 수동 로또 구매 금액을 뺀 금액)으로 만들수 있다. 
    - [x] 잔여 금액이 비어있는 로또 일급 컬렉션을 반환한다.
- 입력한 금액, 자동 생성 숫자, 수동 생성 번호를 입력하도록 해야 한다.
  - [x] 로또 입력기는 수동 로또 구매 희망 횟수를 입력받는다.
  - [x] 로또 입력기는 수동 로또 구매 희망 번호 목록을 입력받는다.
