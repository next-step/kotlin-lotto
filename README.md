...
#### 로또
- [x] 로또는 6개의 중복되지 않은 숫자로 구성되어 있다.
- [x] 로또의 구성된 6개의 숫자 중 중복이 있으면 예외를 던진다.
- [x] 로또의 가격은 1,000원이다.
- [ ] 6개의 숫자중 3~6개의 숫자가 당첨 숫자와 일치하면 상금을 획득한다.
- [ ] n개의 로또를 구매하면 수익률을 알 수 있다.
- [ ] 당첨 번호는 중복되지 않은 6개 이다.
- [ ] 당첨 번호에 중복되는 숫자가 있으면 예외를 던진다.
