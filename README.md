...
- [x] 수동으로 로또를 구매
  - [x] 구매할 로또 수량을 입력받는다.
  - [x] 로또 수량만큼 로또를 발행한다.
    - [x] 수동 발행 로또와 자동 발행 로또를 merge한다 (불변 지키기)
- [x] 수동과 자동으로 구매한 수량을 나타내는 메시지가 수정된다.

## 기능 요구 사항

- [x] 수동으로 로또를 구매할 수 있다.
  - [x] 로또 수량을 입력 받을 수 있다.
    - [x] 수동으로 구매할 로또 수량은 0이 될 수 있다.
  - [x] 로또 수량만큼 로또를 발행할 수 있다.
- [x] 수동과 자동으로 구매한 수량을 나타내는 메시지가 수정돼야 한다.
