...
- 로또 구입 금액을 입력하면 구입 금액에 해당하는 로또를 발급해야 한다.
  ...
  - 돈이 있다.
    - [x] 돈은 정수 하나로 생성된다.
    - [ ] 돈은 0원 이하가 될 수 없다.
    - [ ] 돈은 서로 다른 객체라도, 금액이 같으면 동일하다.
  - 로또가 있다.
    - [ ] 로또는 로또숫자열 하나로 생성된다.
    - [ ] 다른 로또숫자열을 받아, 자신의 로또숫자열과 일치하는 수가 몇 개인지 반환한다.
  - 로또숫자열이 있다.
    - [ ] 로또숫자열은 여섯 개의 로또숫자로 생성된다.
    - [ ] 로또숫자열 내의 로또숫자는 서로 같을 수 없다.
    - [ ] 로또숫자열 내의 로또숫자는 생성 시 순서와 관계없이 정렬되어 있다.
    - [ ] 다른 로또숫자열과 비교하면, 일치하는 로또숫자의 개수를 반환한다.
  - 로또숫자가 있다.
    - [ ] 로또숫자는 정수를 입력받아 생성한다.
    - [ ] 로또숫자의 범위는 1부터 45까지의 정수이다.
    - [ ] 로또숫자는 서로 다른 객체라도, 값이 같으면 동일하다.
  - 당첨통계가 있다.
    - [ ] 당첨통계는 로또숫자열과 로또 리스트와 로또 하나의 가격으로 생성된다.
    - [ ] 통계 조회를 하면 3개부터 6개까지 일치하는 개수를 알려준다.
    - [ ] 총 수익률을 조회하면, 총 로또 금액 구입 대비 당첨액 비율을 알려준다.
