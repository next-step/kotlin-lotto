...
class LottoPurchaseInfoTest {
    @Test
    fun successCase() {
        val lottoPurchaseInfo = LottoPurchaseInfo(14123, 3)
        ...
        assertThat(lottoPurchaseInfo.calculateAutoLottoCount()).isEqualTo(11)
    }

    @Test
    fun failureAmountCase() {
        try {
            LottoPurchaseInfo(0, 3)
