...
//        val firstWinningNumbers = LottoGame(1, 2, 3, 4, 5, 6)
//        val ticket = LottoTicket(LottoAutomaticOrderStrategy.issue(20))
//        val winingNumbers = WinningNumbers(firstWinningNumbers, LottoNumber(7))
