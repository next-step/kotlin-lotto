...
class WinnerLottoTicketTest : StringSpec({
    ...
    "로또 티켓과 보너스 볼로 생성" {
        shouldNotThrowAny {
            WinnerLottoTicket(ONE_TO_SIX_LOTTO_TICKET, LottoNumber(7))
        }
    }

    "로또 티켓에는 보너스 볼을 포함할 수 없음" {
        shouldThrowExactly<IllegalArgumentException> {
            WinnerLottoTicket(ONE_TO_SIX_LOTTO_TICKET, LottoNumber(1))
        }
    }
    ...
    "로또 티켓 조회" {
        ...
        winnerLottoTicket.lottoTicket shouldBe ONE_TO_SIX_LOTTO_TICKET
    }
