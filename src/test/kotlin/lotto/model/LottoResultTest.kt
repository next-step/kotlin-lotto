    ...
    companion object {
        ...
        fun lottoResultProvider(): List<Arguments> {
            return listOf(
                Arguments {
                    arrayOf(
                        LottoResult(mapOf(FIRST to 0, SECOND to 1, THIRD to 1, FOURTH to 0), Money(10_000)),
                        LottoResult(mapOf(FIRST to 0, SECOND to 1, THIRD to 1, FOURTH to 0), Money(10_000)),
                        true
                    )
                },
                Arguments {
                    arrayOf(
                        LottoResult(mapOf(FIRST to 0, SECOND to 1, THIRD to 1, FOURTH to 0), Money(10_000)),
                        LottoResult(mapOf(FIRST to 1, SECOND to 1, THIRD to 0, FOURTH to 0), Money(10_000)),
                        false
                    )
                },
                Arguments {
                    arrayOf(
                        LottoResult(mapOf(FIRST to 0, SECOND to 1, THIRD to 1, FOURTH to 0), Money(10_000)),
                        LottoResult(mapOf(FIRST to 0, SECOND to 1, THIRD to 1, FOURTH to 0), Money(23_000)),
                        false
                    )
                }
            )
        ...
        fun benefitRateProvider(): List<Arguments> {
            return listOf(
                Arguments {
                    arrayOf(
                        LottoResult(mapOf(FIRST to 0, SECOND to 0, THIRD to 0, FOURTH to 1), Money(5_000)),
                        1.0
                    )
                },
                Arguments {
                    arrayOf(
                        LottoResult(mapOf(FIRST to 0, SECOND to 0, THIRD to 0, FOURTH to 0), Money(5_000)),
                        0.0
                    )
                },
                Arguments {
                    arrayOf(
                        LottoResult(mapOf(FIRST to 0, SECOND to 0, THIRD to 0, FOURTH to 1), Money(14_000)),
                        0.35
                    )
                }
            )
