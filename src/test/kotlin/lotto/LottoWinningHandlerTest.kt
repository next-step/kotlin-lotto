...
class LottoWinningHandlerTest {
    ...
    fun `발급된 로또와 일치하는 숫자만큼의 결과를 출력해야 한다`() {
        val issuedLottos = listOf(
            LottoTicket(
                listOf(
                    LottoNumber(1), LottoNumber(5), LottoNumber(6), LottoNumber(8), LottoNumber(9), LottoNumber(11)
                )
            ),
            LottoTicket(
                listOf(
                    LottoNumber(2), LottoNumber(4), LottoNumber(5), LottoNumber(6), LottoNumber(8), LottoNumber(22)
                )
            ),
            LottoTicket(
                listOf(
                    LottoNumber(1), LottoNumber(4), LottoNumber(5), LottoNumber(6), LottoNumber(12), LottoNumber(45)
                )
            ),
        )
