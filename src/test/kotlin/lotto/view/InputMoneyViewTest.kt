...
internal class InputMoneyViewTest : StringSpec({
    ...
    "입력 뷰는 보유 금액과 수동 로또 수량을 입력받아 반환한다." {
        ...
        val result = view.getMoney()

        result shouldBe OrderLotteryRequestDTO(Money(1000), listOf(listOf(1, 2, 3, 4, 5, 6).toLotteryNumberSet()))
    }
})
...
class StubIOSystem(private val inputMoney: List<String>) : IOSystem {
    ...
    override fun read(): String = inputMoney[index++]
