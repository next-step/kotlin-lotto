...
class LottoWinningNumbersTest {
    ...
    companion object {
        ...
        fun lottoCandidates(): Stream<Arguments> = Stream.of(
            Arguments.arguments(LottoNumbers(1, 2, 3, 4, 5, 6), LottoPrice.ALL_MATCHED),
            Arguments.arguments(LottoNumbers(1, 2, 3, 4, 5, 7), LottoPrice.FIVE_MATCHED_WITH_BONUS),
            Arguments.arguments(LottoNumbers(1, 2, 3, 4, 5, 8), LottoPrice.FIVE_MATCHED),
            Arguments.arguments(LottoNumbers(1, 2, 3, 4, 8, 7), LottoPrice.FOUR_MATCHED),
            Arguments.arguments(LottoNumbers(1, 2, 3, 9, 8, 7), LottoPrice.THREE_MATCHED),
            Arguments.arguments(LottoNumbers(1, 2, 10, 9, 8, 7), LottoPrice.TWO_MATCHED),
            Arguments.arguments(LottoNumbers(1, 11, 10, 9, 8, 7), LottoPrice.ONE_MATCHED),
            Arguments.arguments(LottoNumbers(12, 11, 10, 9, 8, 7), LottoPrice.NOT_MATCHED)
        )
    }
}
