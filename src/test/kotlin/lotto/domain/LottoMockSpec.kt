...
class LottoMockSpec : FunSpec({
    test("주어진 당첨 조건에 해당하는 로또 티켓 생성") {
        ...
        forAll(
            ...
            result.numbers.count { winningLotto.winningTicket.numbers.contains(it) } shouldBe matchedCount
            result.numbers.contains(winningLotto.bonusNumber) shouldBe hasMatchedBonus
        }
    }
