...
class LottoPrizeManagerTest : DescribeSpec({
    ...
    it("당첨 통계를 알수 있습니다") {
        ...
        val winningLottoNumbers = LottoTicketNumbers.ofInts(allMatchedWinningLottoInts)
        ...
        // then
        // 6개 번호 일치한 당첨 정책 확인
        winningStats[0].lottoPrizePolicy.wonMatchedCount shouldBe 6
        ...
        // 3개 일치한 당첨 정책 확인
        winningStats[1].lottoPrizePolicy.wonMatchedCount shouldBe 3
