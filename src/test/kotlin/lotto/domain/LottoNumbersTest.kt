...
class LottoNumbersTest {
    ...
    companion object {
        ...
        fun lottoCandidates(): Stream<Arguments> = Stream.of(
            Arguments.arguments(LottoNumbers(1, 2, 3, 4, 5, 6), 6),
            Arguments.arguments(LottoNumbers(1, 2, 3, 4, 5, 7), 5),
            Arguments.arguments(LottoNumbers(1, 2, 3, 4, 8, 7), 4),
            Arguments.arguments(LottoNumbers(1, 2, 3, 9, 8, 7), 3),
            Arguments.arguments(LottoNumbers(1, 2, 10, 9, 8, 7), 2),
            Arguments.arguments(LottoNumbers(1, 11, 10, 9, 8, 7), 1),
            Arguments.arguments(LottoNumbers(12, 11, 10, 9, 8, 7), 0)
        )
    }
}
