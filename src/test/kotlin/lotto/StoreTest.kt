...
class StoreTest {
    ...
    @Test
    fun 꽝() {
        val winnerHistory = Store.drawLottoNumber(buyer.autoLotto, Lotto(setOf(7, 8, 9, 10, 11, 12)), 45)
    ...
    @Test
    fun `5천원 당첨`() {
        val winnerHistory = Store.drawLottoNumber(buyer.autoLotto, Lotto(setOf(1, 2, 3, 14, 15, 16)), 45)
    ...
    @Test
    fun `5만원 당첨`() {
        val winnerHistory = Store.drawLottoNumber(buyer.autoLotto, Lotto(setOf(1, 2, 3, 4, 15, 16)), 45)
    ...
    @Test
    fun `150만원 당첨`() {
        val winnerHistory = Store.drawLottoNumber(buyer.autoLotto, Lotto(setOf(1, 2, 3, 4, 5, 16)), 45)
    ...
    @Test
    fun `3천만원 당첨`() {
        val winnerHistory = Store.drawLottoNumber(buyer.autoLotto, Lotto(setOf(1, 2, 3, 4, 5, 16)), 6)
    ...
    @Test
    fun `20억 당첨`() {
        val winnerHistory = Store.drawLottoNumber(buyer.autoLotto, Lotto(setOf(1, 2, 3, 4, 5, 6)), 45)
