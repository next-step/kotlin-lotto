...
class WinningLottoNumberListTest : FunSpec({
    ...
    test("로또 당첨 번호 리스트 생성시 []을 넣을 경우 예외(IllegalArgumentException)를 던진다.") {
        shouldThrow<IllegalArgumentException> {
            WinningLottoNumbers.valueOf("1, 2, 3, 4, 5")
        }
    }
