...
class MatchResultTest {
    ...
    fun `당첨금액을 구입금액으로 나눈 수익률을 반환한다`() {
        ...
        matchResult.rateOfReturn(GameMoney.from(14000)) shouldBe 0.35.toBigDecimal()
    }
    ...
    fun `당첨 결과가 없는 경우 수익률이 0이다`() {
        ...
        matchResult.rateOfReturn(GameMoney.from(1000)) shouldBe 0.00.toBigDecimal().setScale(2)
    }
