...
class StringAddCalculatorTest {
    ...
    fun emptyOrNull(text: String?) {
        assertThat(add(text)).isSameAs(0)
    }
    ...
    fun oneNumber(text: String) {
        assertThat(add(text)).isSameAs(Integer.parseInt(text))
    }
    ...
    fun twoNumbers(text: String) {
        assertThat(add(text)).isSameAs(3)
    }
    ...
    fun negativeOrNotNumberString() {
        assertThatThrownBy { add("3,5:-1:9") }.isInstanceOf(RuntimeException::class.java)
        assertThatThrownBy { add("3,5:k:9") }.isInstanceOf(RuntimeException::class.java)
    }
}
