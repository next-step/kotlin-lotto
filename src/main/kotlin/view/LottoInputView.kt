...
object LottoInputView {
    ...
    private const val ERR_MSG_EXCEED_WINNING_NUMBERS = "당첨 번호 입력 개수를 초과하였습니다."
    ...
    fun validateWinningNumberList(winningNumberList: List<String>) {
        if(winningNumberList.size > 6) {
            throw IllegalArgumentException(ERR_MSG_EXCEED_WINNING_NUMBERS)
        }
    }
}
