...
class NumberSplit(private val text: String?) {
    fun splitNumberResult(): Numbers {
        ...
        if(text.toIntOrNull() != null && text.toIntOrNull()!! < 0) throw RuntimeException(INVALID_NEGATIVE_MESSAGE)
    ...
    private fun nullCheckTextToInt(text: String): Int {
        ...
        if(numberOrNull < 0) throw RuntimeException(INVALID_NEGATIVE_MESSAGE)
        return numberOrNull
    }
