...
class TicketMachine {
    fun sellTickets(money: Money, manualTicketNumbers: List<MarkedNumbers>): Tickets {
    ...
    private fun sellManualTickets(money: Money, manualTicketNumbers: List<MarkedNumbers>): List<Ticket> {
