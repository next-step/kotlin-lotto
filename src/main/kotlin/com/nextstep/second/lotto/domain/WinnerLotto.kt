...
class WinnerLotto private constructor(
    val lotto: Lotto,
    private val bonusNumber: LottoNumberVo
) {

    fun countSameNumbers(targetLotto: Lotto): Int {
        return lotto.numbers.intersect(targetLotto.numbers.toSet()).size
    }

    fun checkBonusNumber(targetLotto: Lotto): Boolean {
    ...
    companion object {
        fun of(inputNumbers: List<Int>, bonusNumber: Int): WinnerLotto {
            ...
            return WinnerLotto(Lotto.of(inputNumbers), LottoNumberVo.of(bonusNumber))
        }
    }
}
