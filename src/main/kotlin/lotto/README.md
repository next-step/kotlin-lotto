...
- [x] Ticket은 무슨 책임을 가지고 있을까요? length, range는 어떤 이유로 생성시점에 받을까요? 내부에 상수로 관리해도 좋을거같아요 init절에서 null체크를 하는데, 굳이 nullable 가능한 값을 받을필요가 있을까요?
- [x] 복잡도가 너무 높은거 같아요!
...
- [x] 당첨 번호 enum으로 만들기
- [x] 리턴 타입 모두 명시하기
- [x] LottoGenerator, Ticket의 책임과 역할 생각해보기
- [x] 복잡한 코드 단순화 하기
