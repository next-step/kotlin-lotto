...
## 기능 명세서
- [x] 수동으로 구매한 로또 수를 입력할수 있다
  - [x] Dto 에서 밸리데이션, 숫자로 정재
    - [x] 정수가 아닌 경우 에러 발생
    - [x] 음수인 경우 에러 발생
```
...
- [x] 수동으로 구매할 번호를 입력할수 있다
  - [x] 수동으로 구매한 로또가 없는 경우 입력 스킵
```
...
-[x] 구매한 로또를 표시할때 수동으로 구매한 로또도 포함하여 보여준다
  -[x] 수동으로 구매한 로또를 먼저 표시해준다
```text
