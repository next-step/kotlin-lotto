...
class Lotto {
    ...
    fun makeRandomNums(): List<Int> = NUM_RANGE.shuffled().take(MAX_SIZE).sorted()

    fun validateNums(numbers: List<Int>) {
    ...
    companion object {
        ...
        val NUM_RANGE = 1..45
        private const val NUMBER_DUPLICATION_EXCEPTION_MSG = "로또 번호는 중복된 숫자를 가질 수 없습니다."
