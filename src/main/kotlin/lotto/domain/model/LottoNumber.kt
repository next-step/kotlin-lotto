...
value class LottoNumber private constructor(val value: Int) {
    ...
    companion object {
        ...
        private const val OUT_OF_RANGE_EXCEPTION_MESSAGE = "로또 숫자의 범위는 1~45 입니다. value=%d"
        ...
        fun get(value: Int): LottoNumber = lottoNumbers.find { it.value == value }
            ?: throw IllegalArgumentException(OUT_OF_RANGE_EXCEPTION_MESSAGE.format(value))
    }
}
