...
value class BuyPrice(val buyPrice: Int) {
    ...
    init {
        require(buyPrice > MIX_PRICE) {
            "구매 가격은 ${MIX_PRICE}보다 높아야 합니다."
        }
        require(buyPrice % DEFAULT_BUY_PRICE == 0) {
            "구매 가격은 ${MIX_PRICE}으로 나누어 떨어져야 합니다."
        }
    }

    companion object {
        private const val DEFAULT_BUY_PRICE = 1000
        private const val MIX_PRICE = 0
