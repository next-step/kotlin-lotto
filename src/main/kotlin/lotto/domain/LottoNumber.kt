...
class LottoNumber private constructor(
    ...
    companion object {
        ...
        private val LOTTO_NUMBER_CASH: Map<Int, LottoNumber> =
            (MINIMUM_LOTTO_NUMBER..MAXIMUM_LOTTO_NUMBER).associateWith(::LottoNumber)

        fun from(number: Int) = LOTTO_NUMBER_CASH[number]
            ?: throw IllegalArgumentException("로또 번호는 1~45 사이의 양의 정수만 구성할 수 있습니다.")
    }
}
