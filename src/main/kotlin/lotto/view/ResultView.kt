...
class ResultView {
    ...
    fun viewPurchaseLotto(lottos: Lottos, autoLottoNumberSize: Int, manualLottoSize: Int) {
        println("수동으로 $manualLottoSize 장, 자동으로 $autoLottoNumberSize 개를 구매했습니다.")
        lottos.toList().forEach {
