...
object InputView {
    ...
    fun validateWinningNumber(inputData: String) {
        require(inputData.split(',').size == 6) {}
    }

    fun splitInputData(inputData: String): List<String> {
        return inputData.split(",").map { it.trim() }
    }
}
